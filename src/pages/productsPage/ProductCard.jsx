const ProductCard = ({ product }) => {
  return (
    <div className="group bg-gradient-to-br from-gray-900 via-[#1a1a1a] to-gray-900 border border-amber-500/20 relative overflow-hidden flex flex-col w-64 h-[450px]">
      {/* Corner accents */}
